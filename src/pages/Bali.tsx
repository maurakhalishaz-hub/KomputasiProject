    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-24">
        <div className="relative h-80 bg-cover bg-center flex items-center justify-center" style={{
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">Pulau Surga dengan Keindahan Seni dan Alam</p>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-sm font-semibold burnt-cocoa uppercase tracking-wide mb-2">Jelajahi Kuliner Bali</p>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Rekomendasi Tempat Makan & Hangout
            </h2>
            <p className="text-gray-600 text-lg">
              Cari tempat terbaik untuk menikmati kuliner lokal dan bersantai dengan suasana yang nyaman di Bali.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-sm font-semibold burnt-cocoa uppercase tracking-wide mb-2">Jelajahi Alam Bali</p>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Rekomendasi Tempat Wisata
            </h2>
            <p className="text-gray-600 text-lg">
              Jangan lewatkan destinasi wisata paling populer dan menakjubkan di Bali dengan keindahan alam yang tak terlupakan.
            </p>
          </div>
